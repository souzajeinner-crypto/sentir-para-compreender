      ...
      <section className="content-container pt-12 pb-16 lg:pt-20 lg:pb-24">
        <div className="flex flex-col lg:flex-row lg:items-center lg:gap-12">
          ...
          <div className="flex-1 mt-12 lg:mt-0 flex items-center justify-center relative">
            <div className="absolute w-[420px] h-[420px] rounded-full opacity-25" style={{ background: "radial-gradient(circle, rgba(139,92,255,0.45) 0%, transparent 65%)" }} aria-hidden="true" />
            <img
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          ...
          <div className="glass-card p-8 flex flex-col">
            ...
            <div className="flex items-end gap-6 mt-auto">
              <div className="flex-shrink-0 w-32 h-32 rounded-2xl bg-gradient-to-br from-violet-600/10 to-violet-900/20 border border-[var(--border-glass)] flex items-center justify-center overflow-hidden">
                <img src="/images/coracao.png.png" alt="" aria-hidden="true" className="w-full h-full object-contain p-2" />
              </div>
        ...
        <div className="relative rounded-banner overflow-hidden" style={{ background: "var(--bg-banner)" }}>
          ...
          <div className="relative flex flex-col sm:flex-row items-center gap-6 p-8 sm:p-10">
            <div className="flex-shrink-0">
              <div className="w-16 h-16 rounded-2xl bg-violet-600/20 border border-violet-500/20 flex items-center justify-center overflow-hidden">
                <img src="/images/mascotes-juntos.png.png" alt="" aria-hidden="true" className="w-full h-full object-contain" />
              </div>
            </div>
